...
function M.random_i64()
    ...
    return INT2HEX(bytes[1])..INT2HEX(bytes[2])..INT2HEX(bytes[3])..INT2HEX(bytes[4])..INT2HEX(bytes[5])..INT2HEX(bytes[6])..INT2HEX(bytes[7])..INT2HEX(bytes[8])
end
